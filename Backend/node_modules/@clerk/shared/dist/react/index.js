...
var useCheckout = (options) => {
  ...
  const manager = (0, import_react7.useMemo)(
  ...
  const managerProperties = (0, import_react7.useSyncExternalStore)(
    (cb) => manager.subscribe(cb),
    () => manager.getState(),
    () => manager.getState()
  );
  const properties = (0, import_react7.useMemo)(() => {
...
var useAttachEvent = (element, event, cb) => {
  const cbDefined = !!cb;
  const cbRef = (0, import_react8.useRef)(cb);
  (0, import_react8.useEffect)(() => {
    cbRef.current = cb;
  }, [cb]);
  (0, import_react8.useEffect)(() => {
...
// src/react/stripe-react/index.tsx
var ElementsContext = import_react9.default.createContext(null);
...
var Elements = ({
  ...
  const parsed = import_react9.default.useMemo(() => parseStripeProp(rawStripeProp), [rawStripeProp]);
  const [ctx, setContext] = import_react9.default.useState(() => ({
  ...
  return /* @__PURE__ */ import_react9.default.createElement(ElementsContext.Provider, { value: ctx }, children);
};
var useElementsContextWithUseCase = (useCaseMessage) => {
  const ctx = import_react9.default.useContext(ElementsContext);
...
var useElementsOrCheckoutSdkContextWithUseCase = (useCaseString) => {
  const elementsContext = import_react9.default.useContext(ElementsContext);
...
var createElementComponent = (type, isServer2) => {
  ...
  const ClientElement = ({
    ...
    const [element, setElement] = import_react9.default.useState(null);
    const elementRef = import_react9.default.useRef(null);
    const domNode = import_react9.default.useRef(null);
    const [isReady, setReady] = (0, import_react9.useState)(false);
    ...
    return /* @__PURE__ */ import_react9.default.createElement(import_react9.default.Fragment, null, !isReady && fallback, /* @__PURE__ */ import_react9.default.createElement(
      "div",
      {
        id,
        className,
...
var PropsProvider = ({ children, ...props }) => {
  ...
  const [isPaymentElementReady, setIsPaymentElementReady] = (0, import_react10.useState)(false);
  return /* @__PURE__ */ import_react11.default.createElement(
...
var PaymentElement2 = ({ fallback }) => {
  ...
  const environment = useInternalEnvironment();
  const applePay = (0, import_react10.useMemo)(() => {
  ...
  const onReady = (0, import_react10.useCallback)(() => {
...
var usePaymentElement = () => {
  ...
  const reset = (0, import_react10.useCallback)(async () => {
    if (!stripe || !elements) {
      return throwLibsMissingError();
    }
