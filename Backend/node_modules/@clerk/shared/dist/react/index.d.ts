...
type UseOrganizationReturn<T extends UseOrganizationParams> = {
    ...
    subscriptions: PaginatedResources<CommerceSubscriptionResource, T['subscriptions'] extends {
        infinite: true;
    } ? true : false> | null;
};
/**
 ...
 * @internal
 */
declare const useSubscriptionItems: <T extends PagesOrInfiniteOptions & {
    infinite?: boolean;
    keepPreviousData?: boolean;
} & {
    for: "organization" | "user";
}>(params: T) => PaginatedResources<CommerceSubscriptionResource, T extends {
    infinite: true;
} ? true : false>;
